...
| **Device identity** | Implied in [`Spatial data and farm asset registry standard`](spatial-data-and-farm-asset-registry-standard.md) (telemetry `device_id`); MQTT topic patterns in **LoRa/MQTT** source-notes | **No** global **naming authority** document; **no** MQTT topic tree **owned** by you |
| **Asset registry** | [`Spatial data and farm asset registry standard`](spatial-data-and-farm-asset-registry-standard.md) (draft); PostGIS / enterprise PostGIS **source-notes** under [`Farm data…`](../topics/farm-data-farmos-and-ag-lab-builds.md) | Draft **standard**; **not** populated with real IDs |
...
| **5. Identity** | **Device ID**, **MQTT topic root**, **TLS/client ID** policy; link [`Spatial data and farm asset registry standard`](spatial-data-and-farm-asset-registry-standard.md) |
