---
title: First 24 months — Phase 0–1 execution (East Tennessee two-site)
page_type: analysis
status: active
created: 2026-04-21
updated: 2026-04-24
...
# First 24 months — Phase 0–1 execution (East Tennessee two-site)

## Purpose

**Capstone** narrative for **T0 → T0+24 months**: **Phase 0–1** **execution** with **pilot** **discipline**. Aligns to **roadmap** **Phases** **0–2** **overlap** ([`10-year roadmap`](east-tennessee-two-site-farm-business-plan-10-year-roadmap.md)) but **does** **not** **assume** **Phase** **2** **herd** **or** **fence** **MVP** **by** **month** **24**.
...
## Windows (relative to T0)

| Window | Roadmap (approx.) | What “good” looks like |
|--------|-------------------|-------------------------|
| **T0 → T0+90d** | Phase **0** + **start** Phase **1** | Books, **V8** **path**, **V1/V3** **started**, **V11** **log**, **manual** **baseline** **on** **water** **started** |
| **T0+3mo → T0+12mo** | Phase **1** | **V2/V4/V5/V6** **evidence**, **repair** **tier** **list**, **telemetry** **pilot** **≤** **one** **cluster** |
| **T0+12mo → T0+18mo** | Phase **1** | **G1** **packet** **complete** **or** **dated** **waivers** **documented**; **pivot** **to** **lease** **if** **grazing** **fails** |
| **T0+18mo → T0+24mo** | Phase **1** **→** **possible** **early** Phase **2** | **G1** **PASS** **→** **permission** **for** **fence/water/herd** **MVP** **per** [`validation backlog`](east-tennessee-two-site-farm-business-plan-validation-backlog.md)—**else** **stay** **pilot** **+** **cheap** **proofs** |

**Most families**: **Month** **24** **still** **in** **Phase** **1** **or** **early** **Phase** **2** **—** **normal**.

**Execution illusion to kill**: **G1** and Phase 2 permission do **not** follow the calendar. If month 24 arrives without evidence, you are still in Phase 1—not “behind schedule,” under-proof.
...
## What **not** to do by month 24 without gates
...
- [`Master checklist`](execution-dossier-master-checklist-phase-0-1-east-tennessee.md)
- [`Pilot and recon checklists`](pilot-and-recon-checklists-first-24-months-two-site-smart-farm.md)
