...
**First drafts shipped (2026-04-21)** — five priority artifacts: [`Dual-site operations model — non-agritourism`](dual-site-operations-model-non-agritourism.md), [`Field telemetry reference architecture — homestead + 120 ac`](field-telemetry-reference-architecture-homestead-120ac.md), [`Spatial data and farm asset registry standard`](spatial-data-and-farm-asset-registry-standard.md), [`Weekly coverage matrix — two-site`](weekly-coverage-matrix-two-site-farm-operations.md), [`Automation degraded modes and manual fallback SOP`](automation-degraded-modes-manual-fallback-sop.md).
