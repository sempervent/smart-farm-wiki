...
| **Comparisons (decision-grade)** | Forces tradeoffs | Repo has **two** comparisons ([`ducks vs chickens`](../comparisons/ducks-vs-chickens-meat-raising.md), [`raw vs wiki`](../comparisons/raw-vs-wiki.md)) | **Medium** | Scenario comparisons: gateway stacks, farmOS vs lightweight |
