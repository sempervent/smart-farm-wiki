---
title: Smart Farm Wiki glossary (hub)
page_type: glossary
status: active
created: 2026-04-21
updated: 2026-04-21
...
# Smart Farm Wiki glossary (hub)

Short **definition-first** entries for terms that recur across **two-site operations**, **telemetry**, and **business plan** pages. For repository mechanics, see [`Synthesis layer`](synthesis-layer.md) and [`Raw vs wiki`](../comparisons/raw-vs-wiki.md).
...
| Term | Page |
|------|------|
| **Degraded mode** (automation) | [`Degraded mode`](../glossary/degraded-mode.md) |
| **SITE_HOME / SITE_FARM** (two-site model) | [`Two-site sites`](../glossary/two-site-sites.md) |
