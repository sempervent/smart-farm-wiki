---
title: Backyard livestock and homestead animal sources
page_type: topic
status: active
created: 2026-04-17
updated: 2026-04-21
...
- [`source-notes/raising-backyard-chickens.md`](../source-notes/raising-backyard-chickens.md)
- [`source-notes/raising-chickens-for-meat.md`](../source-notes/raising-chickens-for-meat.md)
- [`source-notes/what-to-know-raising-homestead-chickens.md`](../source-notes/what-to-know-raising-homestead-chickens.md)
- [`source-notes/sustainable-egg-meat-flock.md`](../source-notes/sustainable-egg-meat-flock.md)
- [`source-notes/raising-cattle-beginning-farmers-guide.md`](../source-notes/raising-cattle-beginning-farmers-guide.md)
...
- [`Precision agriculture`](../concepts/precision-agriculture.md) — formal PA framing vs backyard scale
- [`LoRa, MQTT, and gateway bridges`](../topics/lora-mqtt-and-gateway-bridges.md) — coop/run **motion** or presence over **LoRa** to **MQTT** (see [`Tracking chickens with motion sensors over LoRa and MQTT (query synthesis)`](../analyses/tracking-chickens-motion-lora-mqtt.md))
