...
| **Operating objects (roles)** | [`Entity layer — operating objects gap audit`](../analyses/entity-layer-operating-objects-gap-audit.md) | **Entities**: [`Labor roles`](../entities/labor-roles-two-site-farm-operations.md), [`Market channel categories`](../entities/farm-market-channel-categories.md), [`Infrastructure categories`](../entities/farm-infrastructure-system-categories.md), [`WAN edge / backhaul`](../entities/wan-edge-and-backhaul-roles.md), [`Field node classes`](../entities/field-node-classes-off-grid-farm-roles.md); full list in [`index.md`](../index.md#entities). |
| **Package hubs** | [`Wiki navigation and structural hubs`](../topics/wiki-navigation-and-structural-hubs.md#five-package-hubs-start-here-for-whole-topics) | **Routers**: [`Platform doctrine`](../topics/platform-doctrine-package-homelab-farm-edge.md), [`Backup / DR`](../topics/backup-disaster-recovery-doctrine-hub.md), [`Off-grid + field networking`](../topics/off-grid-power-and-field-networking-hub.md), [`Local site intelligence`](../topics/local-site-and-county-intelligence.md), [`Execution & pilots`](../topics/business-plan-execution-and-pilot-operations-hub.md). |
| **Operational standards** | [`Operational standards — farm and homelab platform`](../topics/operational-standards-farm-homelab-platform.md) | Pi, k3s, Longhorn scheduling, secrets, observability, backup cadence, field/WAN naming, **SITE_*** network boundaries. |
...
| **Regulatory & site evidence (TN / federal)** | [`Authoritative execution evidence cluster — East Tennessee`](../source-notes/authoritative-execution-evidence-cluster-east-tennessee.md), [`Execution readiness gap audit`](../analyses/execution-readiness-gap-audit-east-tennessee-operational-knowledge.md), [`Evidence hardening audit (2026-04)`](../analyses/evidence-hardening-audit-east-tennessee-two-site-2026-04.md) | Soils, NASS rents, DOR/ag exemption, FSA captures, septic, CISA—**index**, not legal advice; **hardening** pass logs **desk portals** + routing (no invented parcel facts). |
| **Named site anchors (Claxton / Demory)** | **Places**: [`Claxton (place)`](../entities/claxton-home-base.md), [`Demory (place)`](../entities/demory-farm-site.md); **intel**: [`Claxton — site intelligence`](../analyses/claxton-home-base-site-intelligence.md), [`Demory — site intelligence`](../analyses/demory-farm-site-intelligence.md); **field baselines**: [`Local evidence package`](../topics/local-evidence-package-east-tennessee-two-site.md); [`Anderson vs Campbell`](../comparisons/anderson-county-vs-campbell-county-operating-implications.md) | County + vault sources; **parcel truth** still local. |
...
| **Off-grid `SITE_FARM` (Demory)** | [`Off-grid systems doctrine package`](off-grid-systems-doctrine-package-demory-farm-site.md) (**first-class** hub), [`Demory site intelligence`](../analyses/demory-farm-site-intelligence.md), [`Off-grid power doctrine`](../analyses/off-grid-power-strategy-demory-farm-site.md), [`Mesh/field RF`](../analyses/mesh-and-field-networking-strategy-off-grid-demory-farm.md), [`Off-grid stop rules`](../analyses/off-grid-operational-decision-rules-power-and-networking-demory-farm.md) (**DR-*** / **CS-5**), [`Off-grid topology (Mermaid)`](../analyses/off-grid-farm-execution-topology-demory-mermaid.md), [`Meshtastic vs HaLow vs Wi‑Fi`](../comparisons/meshtastic-wi-fi-halow-conventional-wi-fi-off-grid-farm-operations.md). Gates: [`Validation plan` off-grid](../analyses/validation-and-pilot-plan-first-24-months-east-tennessee-two-site.md#off-grid-demory-validation-gates), [`First 90 days`](../analyses/execution-first-90-days-phase-0-1-east-tennessee.md). |
...
| [`Backup and disaster recovery package — smart farm stack`](../analyses/backup-and-disaster-recovery-package-smart-farm-stack.md) | **DR spine** (farmOS, PostgreSQL, k3s, Longhorn, Rancher, secrets, edge); [`backup comparison`](../analyses/backup-strategy-comparison-farmos-homelab-postgresql-containers.md), [`restore tiers`](../analyses/restore-recovery-tiers-homelab-farm-systems.md), [`DR decision rules`](../analyses/disaster-recovery-decision-rules-farm-edge-stack.md), [`recovery drill runbook`](../analyses/runbook-backup-validation-and-recovery-drill.md) |
...
| [`Platform doctrine package — homelab / farm edge`](platform-doctrine-package-homelab-farm-edge.md) | **First-class** Pi + k3s + Longhorn + Rancher doctrine; [`platform strategy`](../analyses/homelab-edge-kubernetes-platform-strategy-pi-k3s-longhorn-rancher.md); [`platform decision memo`](../analyses/platform-decision-memo-phase-homelab-k3s-pi-fleet-2026-04-18.md); **runbook**: [`How to provision k3s, Longhorn, and Rancher on a Raspberry Pi fleet`](../analyses/how-to-provision-k3s-longhorn-and-rancher-on-a-raspberry-pi-fleet.md); [`k3s/Longhorn captures`](../source-notes/k3s-longhorn-rancher-pi-platform-official-captures-inbox-2026-04-18.md) |
