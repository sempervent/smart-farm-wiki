...
[Edit this page](https://github.com/longhorn/website/edit/master/content/docs/1.11.1/advanced-resources/system-backup-restore/restore-longhorn-system.md)
...
- Longhorn restores the resource from the [Longhorn System Backup Bundle](https://longhorn.io/docs/1.11.1/advanced-resources/system-backup-restore/backup-longhorn-system#longhorn-system-backup-bundle).
...
- Have a Longhorn system backup.
	See [Backup Longhorn System - Create Longhorn System Backup](https://longhorn.io/docs/1.11.1/advanced-resources/system-backup-restore/backup-longhorn-system#create-longhorn-system-backup) for instructions.
...
2. [Create Longhorn System Restore](#create-longhorn-system-restore).

## Configurable Settings

Some settings are excluded as configurable before the Longhorn system restore.

- [Concurrent volume backup restore per node limit](https://longhorn.io/docs/1.11.1/references/settings/#concurrent-volume-backup-restore-per-node-limit)
- [Concurrent replica rebuild per node limit](https://longhorn.io/docs/1.11.1/references/settings/#concurrent-replica-rebuild-per-node-limit)
...
2. [Restart the Longhorn system restore](#restart-longhorn-system-restore).
