...
You'll first want to make sure you have a decent grasp of the [conceptual overview](https://www.wireguard.com/#conceptual-overview), and then [install WireGuard](https://www.wireguard.com/install/). After that, read onwards here.
...
<video controls="" width="100%"><source src="https://www.wireguard.com/talks/talk-demo-screencast.mp4"></video>

Or individually, a single configuration looks like:

![wg(8) walkthrough](https://www.wireguard.com/img/walkthrough.gif)
...
![wg(8) tool](https://www.wireguard.com/img/wg-tool.png)
...
![wg-quick(8) tool](https://www.wireguard.com/img/wg-quick-tool.gif)
...
After [installing](https://www.wireguard.com/install/) WireGuard, if you'd like to try sending some packets through WireGuard, you may use, for testing purposes only, the script in [`contrib/ncat-client-server/client.sh`](https://git.zx2c4.com/wireguard-tools/plain/contrib/ncat-client-server/client.sh).
