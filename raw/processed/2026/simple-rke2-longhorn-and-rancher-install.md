...
![rke_install](https://ranchergovernment.com/hs-fs/hubfs/rke_install.jpg?width=2217&height=450&name=rke_install.jpg)

rke\_install

Let's validate everything worked as expected. Run a `systemctl` status `rke2-server` and make sure it is active.

![rke_status (1)](https://ranchergovernment.com/hs-fs/hubfs/rke_status%20(1).jpg?width=2292&height=474&name=rke_status%20(1).jpg)
...
![rke_nodes](https://ranchergovernment.com/hs-fs/hubfs/rke_nodes.jpg?width=2295&height=225&name=rke_nodes.jpg)
...
![rke_agent](https://ranchergovernment.com/hs-fs/hubfs/rke_agent.jpg?width=2208&height=513&name=rke_agent.jpg)
...
![moar_nodes](https://ranchergovernment.com/hs-fs/hubfs/moar_nodes.jpg?width=2274&height=204&name=moar_nodes.jpg)
...
Quick note about Rancher. Rancher needs jetstack/cert-manager to create the self signed TLS certificates. We need to install it with the Custom Resource Definition (CRD). Please pay attention to the `helm` install for Rancher. The URL will need to be changed to fit your FQDN. Also notice I am setting the `bootstrapPassword` and replicas. This allows us to skip a step later.
...
\\`\`\`
echo https://rancher.dockr.life/dashboard/?setup=$(kubectl get secret --namespace cattle-system bootstrap-secret -o go-template="")
\\`\`\`
...
![tls_error](https://ranchergovernment.com/hs-fs/hubfs/tls_error.jpg?width=2325&height=1287&name=tls_error.jpg)
...
![welcome](https://ranchergovernment.com/hs-fs/hubfs/welcome.jpg?width=2499&height=1536&name=welcome.jpg)

We need to validate the Server URL and accept the terms and conditions. And we are in!

![dashboard](https://ranchergovernment.com/hs-fs/hubfs/dashboard.jpg?width=3096&height=1932&name=dashboard.jpg)
...
![charts](https://ranchergovernment.com/hs-fs/hubfs/charts.jpg?width=2688&height=1677&name=charts.jpg)

Now for the good news, [Longhorn docs](https://longhorn.io/docs/1.8.1/deploy/install/) show two easy install methods. Helm and `kubectl`. Let's stick with Helm for this guide.
...
One of Rancher's benefits is its ability to adjust to what's installed. The Rancher GUI will see that Longhorn is installed and provide a link. Click it.

![longhorn_installed](https://ranchergovernment.com/hs-fs/hubfs/longhorn_installed.jpg?width=2370&height=1473&name=longhorn_installed.jpg)

longhorn\_installed

This brings up the Longhorn GUI

![longhorn](https://ranchergovernment.com/hs-fs/hubfs/longhorn.jpg?width=2577&height=1587&name=longhorn.jpg)
